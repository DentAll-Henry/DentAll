                ...
                if (r.eng !== roleAuth)
                  return (
                    <button
                      ...
                      className={
                        r.eng === roleAuth
                          ? "rounded block px-4 py-2 text-sm text-gray-300 w-full text-left bg-greenD-500"
                          : "rounded block px-4 py-2 text-sm text-black w-full text-left bg-greenD-500 hover:bg-greenD-400"
                      }
                      key={index}
