...
const ModalNuevaCita: React.FC<ModalCitaProps> = ({ date_time, modalOpen, goNext }) => {
    ...
    return (
        <div className=" flex flex-col items-center bg-darkD-500 text-white p-8">
            ...
            <Formik
                ...
                onSubmit={(values) => {
                    ...
                    axiosInstance.post("/appointments", {
                        ...
                        Swal.fire({
                            title: "Error!",
                            html: `Ha ocurrido un error al agendar la cita.\n<ul>${error.response.data.message.map((e: any) => { return `<li>${e}</li>` })}</ul>`,
                            icon: "success",
                            confirmButtonText: "OK",
                            customClass: {
                                confirmButton:
                ...
                <Form>
                    <div className="mb-4">
                        ...
                        <Select
                            classNames={{
                                control: (state) =>
                                    'border-2 border-white bg-darkD-500 text-white rounded-lg',
                            }}
                            theme={(theme) => ({
                                ...theme,
                                borderRadius: 0,
                    ...
                    <button type="submit" className="bg-greenD-500 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded">
                        Agendar
                    </button>
                </Form>
            </Formik>
