...
function BarChart() {
            ...
            if (context) {
                const backgroundColorPlugin = {
                    ...
                    beforeDraw: (chart: any) => {
                        ...
                        ctx.fillStyle = '#1D1D1D'; // Cambia el color de fondo aquí
                ...
                const config: ChartConfiguration<'bar'> = {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            borderWidth: 1,
                            barThickness: 40, // Ajusta el ancho de las barras aquí
                        }],
                    },
                    options: {
                        responsive: true,
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: "Resumen Estadístico",
                                // className: 'text-gray-400', // Clase de Tailwind para color del texto del título
                                font: {
                                    size: 18, // Tamaño del texto del título
                                    weight: "bold", // Texto en negrita
                                },
    ...
    return (
        <div className="relative w-[90%] h-auto">
            <canvas ref={chartRef} className="rounded-xl" /> {/* Aplica border-radius y padding con Tailwind */}
        </div>
    );
}
