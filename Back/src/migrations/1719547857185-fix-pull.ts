...
export class FixPull1719547857185 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "stock" integer NOT NULL, "price" double precision NOT NULL, "description" character varying NOT NULL, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "productsReport" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL, "report_id" uuid, CONSTRAINT "PK_ee9c0d56229e936a422b58fd3d2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "patient" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "person_id" uuid, "clinicalHistory_id" uuid, CONSTRAINT "REL_b829cf7046dfb9d4e510984e97" UNIQUE ("person_id"), CONSTRAINT "REL_cb74e14f5644ba9eab02e0b0be" UNIQUE ("clinicalHistory_id"), CONSTRAINT "PK_8dfa510bb29ad31ab2139fbfb99" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "dentists" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "career" character varying NOT NULL, "speciality" character varying NOT NULL, "person_id" uuid, CONSTRAINT "REL_8aa1576056cbbb4db27683d3fd" UNIQUE ("person_id"), CONSTRAINT "PK_ae1fbd6ec33d24fc0939c23325d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "appointments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date_time" TIMESTAMP NOT NULL, "description" character varying(255), "dentis_id" uuid, "patientId" uuid, "serviceId" uuid, CONSTRAINT "PK_4a437a9a27e948726b8bb3e36ad" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "report" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "appointmentId" uuid, CONSTRAINT "PK_99e4d0bea58cba73c57f935a546" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_7d32d4e5167ef6c6f84e78ce35" ON "products_report" ("productReport_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0e5fef8c43e7c2ab4ab21336a5" ON "products_report" ("product_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "people_roles" ("peopleId" uuid NOT NULL, "rolesId" uuid NOT NULL, CONSTRAINT "PK_ccdb3638b37b04982c1981d39cd" PRIMARY KEY ("peopleId", "rolesId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_6a98be3db49637ef3d8130e755" ON "people_roles" ("peopleId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_51935f695d98071cbac73668e4" ON "people_roles" ("rolesId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "productsReport" ADD CONSTRAINT "FK_1f24374b4390a040725b337dd23" FOREIGN KEY ("report_id") REFERENCES "report"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "systemic_background" ADD CONSTRAINT "FK_065df4322dd9d4bd304ced472ee" FOREIGN KEY ("clinicalHistoryId") REFERENCES "clinical_history"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "patient" ADD CONSTRAINT "FK_b829cf7046dfb9d4e510984e977" FOREIGN KEY ("person_id") REFERENCES "people"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "patient" ADD CONSTRAINT "FK_cb74e14f5644ba9eab02e0b0be0" FOREIGN KEY ("clinicalHistory_id") REFERENCES "clinical_history"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "dentists" ADD CONSTRAINT "FK_8aa1576056cbbb4db27683d3fd2" FOREIGN KEY ("person_id") REFERENCES "people"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "appointments" ADD CONSTRAINT "FK_10e1c3f1dd3fc996189f55f1be5" FOREIGN KEY ("dentis_id") REFERENCES "dentists"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "appointments" ADD CONSTRAINT "FK_f77953c373efb8ab146d98e90c3" FOREIGN KEY ("serviceId") REFERENCES "dental_serv"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "report" ADD CONSTRAINT "FK_624dba53e23dc24c94313775a31" FOREIGN KEY ("appointmentId") REFERENCES "appointments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "products_report" ADD CONSTRAINT "FK_7d32d4e5167ef6c6f84e78ce35c" FOREIGN KEY ("productReport_id") REFERENCES "productsReport"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "products_report" ADD CONSTRAINT "FK_0e5fef8c43e7c2ab4ab21336a52" FOREIGN KEY ("product_id") REFERENCES "product"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "people_roles" ADD CONSTRAINT "FK_6a98be3db49637ef3d8130e755f" FOREIGN KEY ("peopleId") REFERENCES "people"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "people_roles" ADD CONSTRAINT "FK_51935f695d98071cbac73668e4d" FOREIGN KEY ("rolesId") REFERENCES "roles"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "people_roles" DROP CONSTRAINT "FK_51935f695d98071cbac73668e4d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "people_roles" DROP CONSTRAINT "FK_6a98be3db49637ef3d8130e755f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "products_report" DROP CONSTRAINT "FK_0e5fef8c43e7c2ab4ab21336a52"`,
    );
    await queryRunner.query(
      `ALTER TABLE "products_report" DROP CONSTRAINT "FK_7d32d4e5167ef6c6f84e78ce35c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "report" DROP CONSTRAINT "FK_624dba53e23dc24c94313775a31"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "appointments" DROP CONSTRAINT "FK_10e1c3f1dd3fc996189f55f1be5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "dentists" DROP CONSTRAINT "FK_8aa1576056cbbb4db27683d3fd2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "dental_serv" DROP CONSTRAINT "FK_53ad13c6c85939b22698374dcb1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "patient" DROP CONSTRAINT "FK_cb74e14f5644ba9eab02e0b0be0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "patient" DROP CONSTRAINT "FK_b829cf7046dfb9d4e510984e977"`,
    );
    await queryRunner.query(
      `ALTER TABLE "systemic_background" DROP CONSTRAINT "FK_065df4322dd9d4bd304ced472ee"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "productsReport" DROP CONSTRAINT "FK_1f24374b4390a040725b337dd23"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_51935f695d98071cbac73668e4"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6a98be3db49637ef3d8130e755"`,
    );
    await queryRunner.query(`DROP TABLE "people_roles"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0e5fef8c43e7c2ab4ab21336a5"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7d32d4e5167ef6c6f84e78ce35"`,
    );
