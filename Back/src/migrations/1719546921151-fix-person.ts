...
export class FixPerson1719546921151 implements MigrationInterface {
    name = 'FixPerson1719546921151'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "appointments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date_time" TIMESTAMP NOT NULL, "description" character varying(255), "dentis_id" uuid, "patientId" integer, "serviceId" uuid, CONSTRAINT "PK_4a437a9a27e948726b8bb3e36ad" PRIMARY KEY ("id"))`);
