...
export class SegundaMigracion1719432854749 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "appointments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date_time" TIMESTAMP NOT NULL, "description" character varying(255), "dentist_id" character varying NOT NULL, "patientId" integer, "serviceId" uuid, CONSTRAINT "PK_4a437a9a27e948726b8bb3e36ad" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "systemic_background" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "info" character varying NOT NULL, "clinicalHistoryId" integer, CONSTRAINT "PK_ece19e1a8edf8253de4677ccb9f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "clinical_history" ("id" SERIAL NOT NULL, "guard_card" character varying NOT NULL, "date" TIMESTAMP NOT NULL, CONSTRAINT "PK_bc39a3e6645cdb43c64210bf833" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "patient" ("id" SERIAL NOT NULL, "person_id" uuid, "clinicalHistory_id" integer, CONSTRAINT "REL_b829cf7046dfb9d4e510984e97" UNIQUE ("person_id"), CONSTRAINT "REL_cb74e14f5644ba9eab02e0b0be" UNIQUE ("clinicalHistory_id"), CONSTRAINT "PK_8dfa510bb29ad31ab2139fbfb99" PRIMARY KEY ("id"))`);
