...
export class CreateDentistPersonDto {
  @Length(2, 20, {
  ...
  @ApiProperty({
    description:
      'A brief professional description.',
    example: 'Experto en corrección de maloclusiones. Utiliza las últimas tecnologías para proporcionar sonrisas hermosas y saludables.'
  })
  description: string;
}
